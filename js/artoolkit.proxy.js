	...
	*/
	ARProxy = function(arController, cameraParam, callback) {
		...
		this.addEventListener('getNFTMarker', function(ev) {
			console.log('[getNFTMarker]', ev, ev.data.index, this.arController.threeNFTMarkers);
